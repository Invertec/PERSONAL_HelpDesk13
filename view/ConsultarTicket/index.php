...
<body class="with-side-menu">
	...
	<div class="page-content">
		<div class="container-fluid">
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								<li><a href="#">Home</a></li>
								<li class="active">Listado de Ticket</li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
				...
				<div class="row" id="viewadmin">
					<div class="col-lg-3">
						<fieldset class="form-group">
							<label class="form-label" for="tick_titulo1">Titulo</label>
							<input type="text" class="form-control" id="tick_titulo1" name="tick_titulo1" placeholder="Ingrese Titulo" required>
						</fieldset>
					</div>

					<div class="col-lg-2">
						<fieldset class="form-group">
							<label class="form-label" for="prio_id1">Prioridad</label>
							<select class="select2" id="prio_id1" name="prio_id1" data-placeholder="Seleccionar">
								<option label="Seleccionar"></option>
	...
	<?php require_once("modalprioridad.php");?>
