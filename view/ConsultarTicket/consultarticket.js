...
function listardatatable(tick_titulo,cat_id,usu_id,prio_id,est_id){
    tabla=$('#ticket_data').dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        ...
        "ajax":{
            ...
            type : "post",
            dataType : "json",
            data:{ tick_titulo:tick_titulo, cat_id:cat_id, usu_id:usu_id, prio_id:prio_id, est_id:est_id},
            error: function(e){
                console.log(e.responseText);
            }
        },
