<?php
    class Ticket extends Conectar{
        ...
        public function insert_ticket($usu_id,$cat_id,$cats_id,$tick_titulo,$tick_descrip){
            ...
            parent::set_names();
            $sql="INSERT INTO tm_ticket (tick_id,usu_id,cat_id,cats_id,tick_titulo,tick_descrip,tick_estado,fech_crea,usu_asig,fech_asig,prio_id,est) VALUES (NULL,?,?,?,?,?,'1',now(),NULL,NULL,'1','1');";
        ...
        public function listar_ticket_TNO($tick_titulo,$prio_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="call listar_ticket_TNO (?,?)";
            $sql=$conectar->prepare($sql);
        ...
        public function listar_ticket_compras($tick_titulo,$prio_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="call listar_ticket_compras (?,?)";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1, "%".$tick_titulo."%");
            $sql->bindValue(2, $prio_id);
            $sql->execute();
        ...
        public function update_ticket_prioridad($tick_id,$prio_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="update tm_ticket 
                set	
        ...
        public function get_ticket_totalabierto(){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="SELECT COUNT(*) as TOTAL FROM tm_ticket where tick_estado='1'";
            $sql=$conectar->prepare($sql);
            $sql->execute();
            return $resultado=$sql->fetchAll();
        }
        ...
        public function get_ticket_totalcerrado(){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="SELECT COUNT(*) as TOTAL FROM tm_ticket where tick_estado='3'";
            $sql=$conectar->prepare($sql);
            $sql->execute();
            return $resultado=$sql->fetchAll();
        } 
